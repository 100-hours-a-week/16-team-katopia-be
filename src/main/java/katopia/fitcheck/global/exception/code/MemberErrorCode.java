...
public enum MemberErrorCode implements ResponseCode {
    ...
    NOT_FOUND_PENDING_MEMBER(HttpStatus.NOT_FOUND, "MEMBER-E-015", "회원가입이 완료되지 않은 사용자입니다."),
    NOT_FOUND_WITHDRAWN_MEMBER(HttpStatus.NOT_FOUND, "MEMBER-E-016", "탈퇴한 사용자입니다."),
