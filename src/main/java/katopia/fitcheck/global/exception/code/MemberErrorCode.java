...
//    ALREADY_REGISTERED_ACCOUNT(HttpStatus.CONFLICT, "MEMBER-E-004", "이미 가입된 계정입니다. 로그인을 시도해주세요."), // AutheErrorCode로 아동
    ...
    NOT_FOUND_MEMBER(HttpStatus.NOT_FOUND, "MEMBER-E-010", "사용자 정보를 찾을 수 없습니다."),
